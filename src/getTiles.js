...
const bank = [
  ...
  /*xxx,26,07/30*/ "SKOLERNJHCLI", // ILL, INCHES, JOKER
  /*XXX,27,07/31*/ "DYEXTWNYOPTT", // WENT, EPOXY, DOTTY
  /*XXX,28,08/01*/ "CEGLHAWLSSYV", // CLASSY, HEW, GAVEL
  /*XXX,29,08/02*/ "LOGONTFCNUHF", // FLUNG, FONT, NOTCH
  /*373,30,08/03*/ "DMYAKDINTBRP", // PYRAMID, BAT, DINK
];
